...
The loaded dataset contains the GCIMS intensity for Anisole and 2-Heptanone in the **patient samples**. The correspondence between the clusters and the analytes can be checked at the [Identification Report] (link)
