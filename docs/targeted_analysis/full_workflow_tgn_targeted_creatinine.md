...
**Random Forest models with GC-IMS + TGN data. Creatinine normalization
implemented**
...
![](full_workflow_tgn_targeted_creatinine_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](full_workflow_tgn_targeted_creatinine_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
