...
base_folder <- paste0("/storage/users/tduran/Projects/targetml-gcims-tools/data/tgn_results/measurements/su/results_", timestamp)
...
annotations <- read.csv(file.path("/storage/users/tduran/Projects/targetml-gcims-tools/data/tgn_additional_files/annotations_patient_measurements_tgn.csv"))
