...
The loaded dataset contains only the **patient samples** and has already been [filtered based on cluster representation](https://github.com/tecladuran/targetml-gcims-tools/blob/main/docs/Untargeted_Old_New/cluster_filtering_summary.md)
