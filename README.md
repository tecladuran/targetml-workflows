...
- Explore the modules in the `R/` directory to identify available functions.
- Use the tables in `data/` as inputs or outputs of the workflows.
- Refer to the documents in `docs/` for detailed explanations and interpretation of results.
